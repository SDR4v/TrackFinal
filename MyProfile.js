...
const MyProfile = () => {
  ...
  const handleUpdateUsername = async (e) => {
    ...
    try {
      ...
      setError(null);
      showConfirmationModal('Username updated successfully', () => setIsModalOpen(false));
    } catch (err) {
  ...
  const handleUpdateEmail = async (e) => {
    ...
    try {
      ...
      setError(null);
      showConfirmationModal('Email updated successfully', () => setIsModalOpen(false));
    } catch (err) {
      setError(err.message);
    } finally {
      setIsProcessing(false); // Reset processing state
  ...
  const handleUpdatePassword = async (e) => {
    ...
    try {
      ...
      setError(null);
      showConfirmationModal('Password updated successfully', () => setIsModalOpen(false));
    } catch (err) {
      setError(err.message);
    } finally {
      setIsProcessing(false); // Reset processing state
    ...
    <div className="content-card profile-page">
      ...
      <div className="profile-header">
        <div className="avatar">
          <i className="fas fa-user-circle" style={{ fontSize: '100px', color: '#ddd' }}></i>
        </div>
              ...
              {editMode.username ? (
                <div className="form-group">
                  ...
                  <div className="form-actions">
                    <button className="action-button primary" onClick={handleUpdateUsername} disabled={isProcessing}>
                      <i className="fas fa-save"></i> {isProcessing ? 'Saving...' : 'Save'}
                    </button>
            ...
            <div className="info-item">
              ...
              {editMode.email ? (
                <div className="form-group">
                  ...
                  />
                  <div className="form-actions">
                    <button className="action-button primary" onClick={handleUpdateEmail} disabled={isProcessing}>
                      <i className="fas fa-save"></i> {isProcessing ? 'Saving...' : 'Save'}
                    </button>
        ...
        <div className="profile-section">
          ...
          {editMode.password ? (
            <div className="form-group">
              ...
              />
              <div className="form-actions">
                <button className="action-button primary" onClick={handleUpdatePassword} disabled={isProcessing}>
                  <i className="fas fa-save"></i> {isProcessing ? 'Saving...' : 'Save'}
                </button>
